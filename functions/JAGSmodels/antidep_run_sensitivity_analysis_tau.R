...
# run jags
fit_unadjust_tau1 <- crossnma.run(model=mod_unadjust_tau1,
                             n.adapt = n.adapt,
                             n.iter=n.iter,
                             n.burnin = n.burnin,
                             thin=thin,
...
# run jags
fit_adjust1_tau1 <- crossnma.run(model=mod_adjust1_tau1,
                                 n.adapt = n.adapt,
                                 n.iter=n.iter,
                                 n.burnin = n.burnin,
                                 thin=thin,
...
# run jags
fit_adjust2_tau1 <- crossnma.run(model=mod_adjust2_tau1,
                                 n.adapt = n.adapt,
                                 n.iter=n.iter,
                                 n.burnin = n.burnin,
                                 thin=thin,
