...
# This file use antidepressants to run these analysis
...
mod_unadjust <- crossnma.model(std.data=gris,
                               trt=drug,
                               study=study,
                               outcome=r,
                               n=n,
...
# run jags
fit_adjust1_main <-
  crossnma(mod_adjust1_main,
           n.adapt = n.adapt,
           n.iter=n.iter,
           n.burnin = n.burnin,
           thin=thin,
           n.chains=n.chains,
           monitor=c("g.act","dev.ipd","resdev.ipd",
                     "totresdev.ipd","rhat.ipd",
                     "dev.ad","resdev.ad","totresdev.ad","rhat.ad"))
